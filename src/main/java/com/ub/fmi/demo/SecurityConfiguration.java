...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests().antMatchers("/users/change-role/{id}","/login","users/register", "/register", "/forgot-password", "/forgot-password/reset-password", "/users/activate-account/{token}","/users/{id}", "/users/reset-password/{token}", "/users/generate-reset-token")
